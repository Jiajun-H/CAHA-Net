...
BASE_CONFIG = {
    ...
    'val_dir': './data/val',          
    'log_dir': './logs_densenet201',    
    'save_dir': './checkpoints_densenet201',
    'num_classes': 4,
    'batch_size': 64,       
    'lr': 1e-3,             
    'epochs': 60,          
...
# ================= 4. DenseNet201-based 模型实现 (从头训练) =================
class BrainTumorDenseNet201(nn.Module):
    def __init__(self, num_classes=4, use_dcn=True, use_ca=True, use_symmetry=True):
        super(BrainTumorDenseNet201, self).__init__()
        self.use_symmetry = use_symmetry
        print(f">>> 初始化 DenseNet201 模型 | DCN: {use_dcn} | CA: {use_ca} | Sym: {use_symmetry}")
        ...
        try:
            ...
            # DenseNet201 默认通道: block2->512, block3->1792, block4->1920
            ch2, ch3, ch4 = 512, 1792, 1920
