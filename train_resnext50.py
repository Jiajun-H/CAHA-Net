...
BASE_CONFIG = {
    ...
    'val_dir': './data/val',          
    'log_dir': './logs_resnext50',    
    'save_dir': './checkpoints_resnext50',
    'num_classes': 4,
    'batch_size': 64,       
    'lr': 1e-3,             
    'epochs': 60,          
...
# ================= 4. ResNeXt50-based 模型实现 (从头训练) =================
class BrainTumorResNeXt50(nn.Module):
    def __init__(self, num_classes=4, use_dcn=True, use_ca=True, use_symmetry=True):
        super(BrainTumorResNeXt50, self).__init__()
        self.use_symmetry = use_symmetry
        print(f">>> 初始化 ResNeXt50 模型 | DCN: {use_dcn} | CA: {use_ca} | Sym: {use_symmetry}")
