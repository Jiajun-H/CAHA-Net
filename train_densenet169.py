...
BASE_CONFIG = {
    ...
    'val_dir': './data/val',          
    'log_dir': './logs_densenet169',    
    'save_dir': './checkpoints_densenet169',
    'num_classes': 4,
    'batch_size': 64,       
    'lr': 1e-3,             
    'epochs': 60,          
...
# ================= 4. DenseNet169-based 模型实现 (从头训练) =================
class BrainTumorDenseNet169(nn.Module):
    def __init__(self, num_classes=4, use_dcn=True, use_ca=True, use_symmetry=True):
        super(BrainTumorDenseNet169, self).__init__()
        self.use_symmetry = use_symmetry
        print(f">>> 初始化 DenseNet169 模型 | DCN: {use_dcn} | CA: {use_ca} | Sym: {use_symmetry}")
        ...
        try:
            ...
            # DenseNet169 默认通道: block2->512, block3->1280, block4->1664
            ch2, ch3, ch4 = 512, 1280, 1664
